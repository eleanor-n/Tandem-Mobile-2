...
const s = StyleSheet.create({
  ...
  headline: { fontSize: 20, fontWeight: "800", fontFamily: "Quicksand_700Bold", color: colors.foreground, textAlign: "center", letterSpacing: -0.4 },
  ...
  upgradeBtnText: { fontSize: 15, fontWeight: "700", fontFamily: "Quicksand_700Bold", color: colors.white },
  laterBtn: { paddingVertical: 8 },
  laterText: { fontSize: 14, color: colors.muted, fontWeight: "500", fontFamily: "Quicksand_500Medium" },
});
